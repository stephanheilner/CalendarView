...
public extension CalendarConfig {
    ...
    func dayView(_ builder: @escaping (Date, Bool, ((Date) -> Bool)?, Binding<Date?>?, Binding<MDateRange?>?) -> some DayView) -> Self { changing(path: \.dayView, to: builder) }
}
...
public struct CalendarConfig: Configurable { public init() {}
    ...
    private(set) var dayView: (Date, Bool, ((Date) -> Bool)?,  Binding<Date?>?, Binding<MDateRange?>?) -> any DayView = DefaultDayView.init
